...
def scrape(url):
    ...
    for book in firefox.find_elements(By.CLASS_NAME, "product_pod"):
        ...
        # Chave 'title' no dict que vai receber o resultado da busca
        # O título está em uma tag anchor que está dentro de uma tah 'H3'
        new_item["title"] = (
        ...
        # O preço do book está em um da classe 'price_color'
