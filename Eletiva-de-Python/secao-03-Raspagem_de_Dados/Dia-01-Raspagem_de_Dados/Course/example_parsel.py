...
# titles = selector.css(".product_price .price_color::text").getall()
# # Estamos utilizando a::attr(title) para capturar somente o valor contido
# # no texto do seletor
...
# # em seguida buscar os valores individualmente
