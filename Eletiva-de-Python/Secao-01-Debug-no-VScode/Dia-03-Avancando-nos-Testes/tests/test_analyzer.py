...
from Course.analyzer import analyze_json_file, read_json_file
...
def test_analyze_json_file():
    ...
    with patch("Course.analyzer.read_json_file", mock_read_json_file):
        assert (
...
def test_read_json_file(tmp_path):
    ...
    with patch("Course.analyzer.json", mock_json):
